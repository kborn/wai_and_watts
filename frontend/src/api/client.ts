import type { AskRequest, MbieGenerationAnnualRecord, MbieGenerationQuarterlyRecord, LawaStateMultiYearRecord, LawaTrendMultiYearRecord, Explanation } from '../types';
