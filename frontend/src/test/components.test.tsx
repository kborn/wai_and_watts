...
describe('AskPage Component', () => {
  ...
  it('displays example questions', () => {
    ...
    expect(screen.getByText('Explain renewable generation trends between 2020 and 2023')).toBeInTheDocument();
    expect(screen.getByText('Compare wind vs hydro generation')).toBeInTheDocument();
    expect(screen.getByText('Provide overview of water quality state distribution')).toBeInTheDocument();
    expect(screen.getByText('Explain trends in excellent water quality sites')).toBeInTheDocument();
  });
