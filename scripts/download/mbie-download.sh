...
echo "   ./scripts/transform.sh mbie.generation.annual \"${TARGET_DIR}/$(basename "${URL}")\" /tmp/mbie_generation_annual.csv"
echo "   ./scripts/transform.sh mbie.generation.quarterly \"${TARGET_DIR}/$(basename "${URL}")\" /tmp/mbie_generation_quarterly.csv"
echo "2. Ingest the contract CSV:"
echo "   ./scripts/ingest.sh mbie.generation.annual /tmp/mbie_generation_annual.csv $(date +%Y-%m-%d) \"MBIE Downloaded Workbook\""
echo "   ./scripts/ingest.sh mbie.generation.quarterly /tmp/mbie_generation_quarterly.csv $(date +%Y-%m-%d) \"MBIE Downloaded Workbook\""
echo ""
