...
echo "   mvn spring-boot:run -q && curl -X POST http://localhost:8080/api/v1/internal/ingest -H 'Content-Type: application/json' -H 'X-Internal-Token: your-dev-token' -d '{\"datasetSourceCode\":\"lawa.water_quality.state.multi_year\",\"filePath\":\"<PATH_TO_CSV_FILE>\",\"publishedDate\":\"$(date +%Y-%m-%d)\",\"releaseLabel\":\"LAWA Downloaded Workbook\"}'"
echo ""
echo "   For trend data:"
echo "   mvn spring-boot:run -q && curl -X POST http://localhost:8080/api/v1/internal/ingest -H 'Content-Type: application/json' -H 'X-Internal-Token: your-dev-token' -d '{\"datasetSourceCode\":\"lawa.water_quality.trend.multi_year\",\"filePath\":\"<PATH_TO_CSV_FILE>\",\"publishedDate\":\"$(date +%Y-%m-%d)\",\"releaseLabel\":\"LAWA Downloaded Workbook\"}'"