...
public class MbieGenerationAnnualParsedRecord {
    ...
    public MbieGenerationAnnualParsedRecord(int periodYear, String fuelTypeRaw, String fuelTypeNorm, BigDecimal generationGwh) {
