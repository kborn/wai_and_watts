...
public class MbieGenerationQuarterlyFactPackBuilder implements FactPackBuilder {
    ...
    public FactPack buildFactPack(ExplanationRequest request) {
        ...
        List<MbieGenerationQuarterlyRecord> records = getRecordsForRequest(request);
        if (!records.isEmpty()) {
    ...
    public boolean canHandle(ExplanationRequest request) {
        ...
        return "mbie.generation.quarterly".equals(String.valueOf(ds));
    }
    ...
    private List<MbieGenerationQuarterlyRecord> getRecordsForRequest(ExplanationRequest request) {
        ...
        List<MbieGenerationQuarterlyRecord> all = repository.findAll();
    ...
    private void buildFuelTypeComparisonFacts(FactPack factPack, List<MbieGenerationQuarterlyRecord> records) {
