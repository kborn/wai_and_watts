...
import nz.waiwatts.ingestion.mbie.MbieGenerationAnnualCsvParser;
import nz.waiwatts.ingestion.mbie.MbieGenerationAnnualParsedRecord;
import nz.waiwatts.ingestion.mbie.MbieGenerationAnnualParser;
...
class MbieAnnualXlsxTransformerTest {
    ...
    void transform_xlsx_matches_expected_contract_csv() throws IOException {
        ...
        String expected = readExpected("real_snapshots/expected/mbie/generation/annual/mbie_generation_annual_expected.csv");
    ...
    void transform_output_parses_with_contract_parser() throws IOException {
        ...
        List<MbieGenerationAnnualParsedRecord> records = parser.parse(new ByteArrayInputStream(csvBytes));
        assertThat(records).isNotEmpty();
    }

    private MbieAnnualXlsxTransformer transformer() {
        return new MbieAnnualXlsxTransformer();
    }
